...
<head>
    ...
    <title>{{ $course->title ?? 'Course Detail' }} - STUDIFY</title>
    ...
    <style>
        ...
        .hover-primary:hover {
            background: linear-gradient(135deg, #175f9c 0%, #2188d4 100%);
        }
        .btn-primary {
            background: linear-gradient(135deg, #1e7ac4 0%, #2a9df4 100%);
            color: white;
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-14">
                <div class="flex items-center">
                    <a href="#" class="text-base font-semibold text-white">STUDIFY</a>
                </div>
