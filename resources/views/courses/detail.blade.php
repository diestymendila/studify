...
<head>
    ...
    <title>Laravel Complete Course - Platform Kursus</title>
...
<body>
    ...
    <div class="main-content">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <!-- Course Card -->
            <div class="bg-white rounded-lg shadow border border-gray-200 overflow-hidden max-w-5xl">
                ...
                <div class="bg-primary px-5 py-4">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="course-badge bg-green-500 text-white">
                            Aktif
                        </span>
                    </div>
                    <h1 class="text-xl font-bold text-white mb-2">Laravel Complete Course</h1>
                ...
                <div class="px-6 py-5">
                    ...
                    <div class="mb-6 mt-2">
                        ...
                        <p class="text-gray-700 text-sm leading-relaxed">Learn Laravel from scratch to advanced</p>
                    </div>
                    ...
                    <div class="mb-6 pb-6 border-b border-gray-200">
                        ...
                        <div class="flex items-center text-gray-700">
                            ...
                            <span class="text-sm">27 Nov 2025 - 27 Feb 2026</span>
                        </div>
                    </div>
                    ...
                    <div class="mb-6 pb-6 border-b border-gray-200">
                        ...
                        @if(isset($course) && $course->contents->count() > 0)
                            <div class="space-y-2">
                                ...
                                <div class="flex items-start py-2">
                                    ...
                                    @if(isset($isEnrolled) && $isEnrolled && auth()->check())
                                        @php
                                            $isCompleted = false;
                                            if (method_exists($content, 'isCompletedBy')) {
                                                try {
                        ...
                        @else
                            <!-- Static materials for demo -->
                            <div class="space-y-2">
                                <div class="flex items-start py-2">
                                    <div class="flex items-start flex-1">
                                        <span class="text-gray-900 font-semibold text-sm mr-3 flex-shrink-0 mt-0.5">1</span>
                                        <span class="text-sm text-gray-900">Introduction to Laravel</span>
                                    </div>
                                </div>
                                <div class="flex items-start py-2">
                                    <div class="flex items-start flex-1">
                                        <span class="text-gray-900 font-semibold text-sm mr-3 flex-shrink-0 mt-0.5">2</span>
                                        <span class="text-sm text-gray-900">Laravel Routing</span>
                                    </div>
                                </div>
                                <div class="flex items-start py-2">
                                    <div class="flex items-start flex-1">
                                        <span class="text-gray-900 font-semibold text-sm mr-3 flex-shrink-0 mt-0.5">3</span>
                                        <span class="text-sm text-gray-900">Laravel Controllers</span>
                                    </div>
                                </div>
                            </div>
                        @endif
                    ...
                    @auth
                        @if(isset(auth()->user()->role) && auth()->user()->role === 'student' && !isset($isEnrolled))
                    ...
                    <!-- Enrolled Actions -->
                    @auth
                        @if(isset(auth()->user()->role) && auth()->user()->role === 'student' && isset($isEnrolled) && $isEnrolled)
                ...
                <div class="px-6 pb-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex items-start justify-between">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900 text-sm">John Teacher</p>
                            <p class="text-xs text-gray-600">Web Development Mentor</p>
                        </div>
                    </div>
                    <a href="https://wa.me/6282198711839" target="_blank" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded text-xs font-medium border border-green-600 transition flex items-center">
