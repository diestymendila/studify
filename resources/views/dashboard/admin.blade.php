<x-app-layout>
    ...
    <style>
        /* Ambil warna navbar */
        .nav-bg {
            background-color: #1b72e8 !important; /* pastikan sesuai warna navbar kamu */
        }

        /* SAMAKAN WARNA BUTTON DENGAN NAVBAR */
        .action-button {
        ...
        .action-button:hover {
            background-color: #155fc2; /* warna hover lebih gelap */
        ...
        .stat-card:hover {
            ...
            box-shadow: 0 8px 24px rgba(27, 114, 232, 0.15);
        ...
        .action-card:hover {
            ...
            box-shadow: 0 4px 12px rgba(27, 114, 232, 0.12);
            border-color: #1b72e8;
